...
const Header: React.FC = () => {
  ...
  const navigationItems: NavigationItem[] = [
    ...
    {
      href: "#experience",
      label: translations.navigation.experience,
  ...
  return (
    <>
      <header className="border-b border-gray-800 bg-gray-950/80 backdrop-blur-sm sticky top-0 z-50">
        <Container>
          <nav className="flex items-center justify-between py-4">
            <div className="text-2xl font-bold text-white font-mono">MRC</div>
      ...
      >
        ...
        {/* Menu Content */}
        <div className="relative h-full flex items-center justify-center pt-10">
          <div
